...
class _PecsDailyActivityScreenState extends State<PecsDailyActivityScreen> with NfcTtsMixin {
  ...
  Future<void> _resolveInitialDeepLink() async {
    ...
    try {
      ...
      if (tagType != 'PECS' || category != 'DAILY_ACTIVITY') {
        final message = 'Thẻ này chưa phù hợp với hoạt động sinh hoạt hằng ngày.';
        logPecsDeepLinkDebug(
          screenName: 'PecsDailyActivity',
